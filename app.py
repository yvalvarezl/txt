...
st.write("Esta herramienta está diseñada como un asistente de comunicación accesibles. Escribe en el cuadro de abajo el texto o mensaje que deseas expresar y haz clic en el botón para generarlo en voz alta.")
